...
function fn(data) {
    ...
    if (data.s.length) {
        ...
        for (var i = 0; i < data.s.length; i++) {
            html += '<li><span class="baiduResult" data-url="http://www.baidu.com/s?wd=' + data.s[i] + '">' + data.s[i] + '</span><span class="b-link float-end">百度搜索</span></li>';
...
function ajax_ex(url, fn) {
    var script = document.createElement("script");
    script.src = 'https: //neteasecloudmusicapi.vercel.app/login/status' + '&cb=' + fn;
    document.body.appendChild(script);
}
//文档增加jqurey功能
function jqueryGet() {
...
function bootstrapGet() {
    ...
    script1.src = "https://cdn.staticfile.org/twitter-bootstrap/5.1.1/js/bootstrap.bundle.min.js";
    var script2 = document.createElement("script");
    script2.src = 'https://code.jquery.com/jquery-3.6.0.js';
    document.head.appendChild(script);
}