...
function fn(data) {
    ...
    if (data.s.length) {
        ...
        for (var i = 0; i < data.s.length; i++) {
            html += '<li><span class="baiduResult">' + data.s[i] + '</span> <a class="b-link float-end" target="_blank" href="http://www.baidu.com/s?wd=' + data.s[i] + ' "> ' + '百度搜索</a></li>';
        }
        ul.innerHTML = '<span class="badge bg-danger float-end">x</span>' +
            html;
    } else {
