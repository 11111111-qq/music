...
$(document).ready(function() {
    ...
    $('.login').on('click', 'div', function() {
            ...
            ajax_ex() $('#musicPool h5').html(lists[_id].name + '<' + lists[_id].num + '首>'); $('#musicPool tbody').empty(); $('#musicPool  tbody').append(load2) var q = new Promise((v, f) => {
...
var $music = $('#music'); $music.attr('src', nowPlay); $('i.play').click(function() {
...
//
//音乐进度更新
var mus = document.getElementById('music'); mus.ontimeupdate = function() {
