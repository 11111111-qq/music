...
$(document).ready(function() {
            ...
            if (user) {
                ...
                console.log(user)
                $('.offcanvas-body.login').css('background', 'url(' + user.bg + ')' + 'no-repeat').css('background-size', 'cover');
                $('.login img').attr('src', user.pic).css('height:100%;)
                        $('.login .infor .nameid').html('id:' + user.id) $('.login .infor .name').html(user.name);
