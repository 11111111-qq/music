...
function fn(data) {
    ...
    if (data.s.length) {
        ...
        for (var i = 0; i < data.s.length; i++) {
            html += '<li><span class="baiduResult" data-url="http://www.baidu.com/s?wd=' + data.s[i] + '">' + data.s[i] + '</span><span class="b-link float-end" data-url="http://www.baidu.com/s?wd=' + data.s[i] + '">'
            百度搜索 < /span></li > ';
