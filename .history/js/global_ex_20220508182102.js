...
$('#loaddata').load('https://mu-two.vercel.app/login/refresh', e => {
        ...
        //tbody
        var load2 = ""; load2 += "<div class=\"load2\">"; load2 += "<span class=\"loading\"><\/span>"; load2 += "<span class=\"loading\"><\/span>"; load2 += "<span class=\"loading\"><\/span>"; load2 += "<span class=\"loading\"><\/span>"; load2 += "<span class=\"loading\"><\/span>"; load2 += "<span class=\"loading\"><\/span>"; load2 += "<\/div>";
        //定义song
