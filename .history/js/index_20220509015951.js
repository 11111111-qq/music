...
$(document).ready(function() {
    ...
    $('#mvv').on('play', function() {
            if ($('.nowMv').length == 0) {
                $('.list-group.mv ').append($('<span class="nowMv active" data-bs-toggle="offcanvas" data-bs-target="#mvplayer">MV</span>'))
            } else {
                $('.nowMv').addleClass('active');

            }

        })
        .on('pause', function() {
            $('.nowMv').removeleClass('active');
        });
